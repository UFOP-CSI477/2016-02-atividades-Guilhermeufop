...
<body>
	<div id="mainDiv">
		...
		<div id="contentAll">	
			...
			<div id="textE">
				<h1 id="title1"> Area do operador </h1>
				<table id="opcoesAdmin">
					<tr> 
						<th> Opcoes </th>
					</tr>
					<tr>
						<th><br><form action="opcaooperador1.php" method="post">
							<input type="submit" value="Alterar valor de produto">
						</form></th>
					</tr>
					<tr>					
						<th><br><form action="opcaooperador2.php" method="post">
							<input type="submit" value="Alterar foto de produto">
						</form></th>					
					</tr>	
					<tr>					
						<th><br><form action="opcaooperador3.php" method="post">
							<input type="submit" value="Alterar descricao de produto">
						</form></th>					
					</tr>	
					<tr>					
