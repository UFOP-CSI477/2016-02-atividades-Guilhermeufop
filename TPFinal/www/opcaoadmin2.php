...
<body>
	<div id="mainDiv">
		...
		<div id="contentAll">	
			...
			<div id="carrinho"> 
				<h2 id="title2"> Excluir produto </h2>
				<p id="text2"> Lembre-se, nao e permitido a exclusao de produtos ja comercializados </p> 
				<form action="excluirproduto.php" method="post">	
					<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspProduto (ID):
					&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<select name="id">
						<?php
							$conexao = new mysqli("localhost","sisroyalty","123456", "royalty"); 
							if($conexao->connect_errno){
								echo "falha na conexao!";
					...
					<?php } ?></select>
					&nbsp&nbsp&nbsp&nbsp&nbsp<input type="submit" value="Excluir">
