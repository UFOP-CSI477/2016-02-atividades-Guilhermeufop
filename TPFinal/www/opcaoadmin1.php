		...
		<div id="contentAll">	
			...
			<div id="textE">
				...
				<form enctype="multipart/form-data" action="novoproduto.php" method="post" id ="form1">
					...
					<p>&nbsp&nbsp&nbsp&nbsp&nbspDescricao:&nbsp&nbsp&nbsp&nbsp <input type="text" name="descricao"> </p>
					...
					<p>&nbsp&nbsp&nbsp&nbspCategoria:&nbsp&nbsp&nbsp&nbsp
						<select name="categoria">
							<option> Aliancas </option>
							<option> Brincos </option>
							<option> Colares </option>
							<option> Pingentes </option>
							<option> Pulseiras </option>
							<option> Solitarios </option>
						</select>
					</p>
