...
<body>
	<div id="mainDiv">
		...
		<div id="contentAll">	
			...
			<div id="carrinho"> 
				<h2 id="title2"> Alterar descricao de produto </h2>
				<form action="alterarproduto3.php" method="post">
					<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspDescricao:
					&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="descricao">	
