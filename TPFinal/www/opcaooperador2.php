...
<body>
	<div id="mainDiv">
		...
		<div id="contentAll">	
			...
			<div id="carrinho"> 
				<h2 id="title2"> Alterar foto de produto </h2>
				<form enctype="multipart/form-data" action="alterarproduto2.php" method="post">
					<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspFoto:
					&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="file" name="foto">	
