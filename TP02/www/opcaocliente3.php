...
<body>
	<div id="mainDiv">
		...
		<div id="contentAll">	
			...
			<div id="textE">
				<table id="tableProdutos">
					...
					<?php
						...
						$sql = "SELECT p.id as id, p.nome, p.preco as preco, p.imagem as imagem, cr.quantidade as quantidade FROM produtos as p, compras as cr WHERE '$idcl' = cr.user_id AND cr.produto_id = p.id AND situacao = 1 ORDER BY cr.created_at";
			...
			<div id="carrinho"> 
				<h2 id="title2"> Finalizar Compra </h2>
				<form action="finalizarcompra.php" method="post" id ="form1">
					&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="submit" value="Finalizar">
				</form>
				<form action="cancelarcompra.php" method="post" id ="form1">
					<p>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="submit" value="Cancelar">
				</form>
